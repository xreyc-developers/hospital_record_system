                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a class="badge badge-danger" href='dept_head_pages_manage_iward_patients.php?del=<?php echo $row->p_id; ?>' onClick="return confirm('Remove  This Record?');"><i class="mdi mdi-delete"></i> Delete</a>
                          <a class="badge badge-primary" href='dept_head_pages_update_iward_patients.php?p_id=<?php echo $row->p_id; ?>'><i class="mdi mdi-check-circle"></i>Update </a>
                          <a class="badge badge-success" href='dept_head_pages_view_out_patient_details.php?p_id=<?php echo $row->p_id; ?>'><i class="mdi mdi-eye-check-outline"></i> View</a>
                        </td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
