                  ...
                  ?>
                    <tbody class="no-border-x">
                      <tr>
                        ...
                        <td> <a class="badge badge-success" href='admin_pages_view_single_pharmaceutical.php?pharm_id=<?php echo $row->pharm_id; ?>'><i class="mdi mdi-eye-check-outline"></i> View</a></td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
                  } ?>
