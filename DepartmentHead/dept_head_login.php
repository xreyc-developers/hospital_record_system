...
if (isset($_POST['login'])) {
  ...
  if ($rs) {
    ...
    header("location:pages_dept_head_dashboard.php");
  } else {
      ...
      <div class="main-content container-fluid">
        <div class="splash-container">
          <div class="card card-border-color card-border-color-primary">
            <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo" width="250"><span class="splash-description">Departmental Heads Login Panel.</span></div>
            <div class="card-body">
              ...
              <form method="post">
                ...
                <div class="form-group row login-tools">
                  <div class="col-6 login-forgot-password"><a href="pages_admin_password_reset.php">Forgot Password?</a></div>
                </div>
