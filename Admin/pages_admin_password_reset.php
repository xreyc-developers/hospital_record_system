       ...
       <div class="main-content container-fluid">
         <div class="splash-container">
           <div class="card card-border-color card-border-color-primary">
             <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo" width="102" height="102"><span class="splash-description">Please enter your username and email address.</span></div>
             <div class="card-body">
               ...
               <div class="splash-footer"><span>Remembered Pssword? <a href="admin_login.php">Login</a></span></div>
