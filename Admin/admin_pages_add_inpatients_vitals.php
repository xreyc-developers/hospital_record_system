                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a class="badge badge-primary" href='admin_pages_capture_out_patient_vitals.php?p_id=<?php echo $row->p_id; ?>'><i class="mdi mdi-check-circle"></i> Capture Vitals</a>
                          <a class="badge badge-success" href='admin_pages_view_out_patient_vitals.php?p_id=<?php echo $row->p_id; ?>'><i class="mdi mdi-eye-check-outline"></i> View Vitals</a>
                        </td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
