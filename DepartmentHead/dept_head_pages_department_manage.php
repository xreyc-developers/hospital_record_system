                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a href='admin_pages_manage_department.php?del=<?php echo $row->dept_id; ?>' onClick="return confirm('Remove  This Record?');"><i class="mdi mdi-delete"></i></a>
                          <a href='admin_pages_update_department.php?dept_id=<?php echo $row->dept_id; ?>'><i class="mdi mdi-check-circle"></i></a>
                        </td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
