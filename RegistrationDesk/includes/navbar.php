  ...
  {?>
                    <nav class="navbar navbar-expand fixed-top be-top-header">
                            <div class="container-fluid">
                              <div class="be-navbar-header"><a class="navbar-brand" href="pages_employee_dashboard.php"></a>
                              </div>
                                  ...
                                  <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                      <div class="user-info">
                                        ...
                                        <a class="dropdown-item" href="employee_change_password.php"><span class="icon mdi mdi-settings"></span>Change Password</a>
