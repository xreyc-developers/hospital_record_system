...
<body>
  <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    <h5 class="my-0 mr-md-auto font-weight-normal">Hospital Record System</h5>
  </div>

  <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    <h1 class="display-4">Hospital Record System</h1>
    <p class="lead">Please login to your respective department.</p>
  </div>
  ...
  <div class="container">
    ...
    <div class="card-deck mb-3 text-center">
      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <h1 class="card-title pricing-card-title"></h1>
          <a href="Admin/admin_login.php" class="btn btn-lg btn-block btn-outline-primary">Login</a>
        </div>
      </div>
    </div>
  </div>
