                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a class="badge badge-success" href='admin_pages_view_administer_drug_patient.php?p_id=<?php echo $row->p_id; ?>'><i class="mdi mdi-eye-check-outline"></i> View</a>
                          <a class="badge badge-primary" href='admin_pages_administer_drug_patient.php?p_id=<?php echo $row->p_id; ?>'><i class="mdi mdi-check-circle"></i> Administer</a>
                        </td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
