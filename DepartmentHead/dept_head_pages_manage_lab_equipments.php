                  ...
                  ?>
                    <tbody class="no-border-x">
                      <tr>
                        ...
                        <td><a class="badge badge-danger" href='dept_head_pages_manage_lab_equipments.php?del=<?php echo $row->id; ?>' onClick="return confirm('Remove  This Record?');"><i class="mdi mdi-delete"></i> Delete</a>
                          <a class="badge badge-success" href='dept_head_pages_manage_singleequipment.php?id=<?php echo $row->id; ?>'><i class="mdi mdi-check-circle"></i> Update</a>
                        </td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
