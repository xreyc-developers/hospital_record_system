                  ...
                  ?>
                    <tbody class="no-border-x">
                      <tr>
                        ...
                        <td><a href='admin_pages_manage_pharmaceutical.php?del=<?php echo $row->pharm_id; ?>' onClick="return confirm('Remove  This Record?');"><i class="mdi mdi-delete"></i></a>
                          <a href='admin_pages_manage_singlepharmaceutical.php?pharm_id=<?php echo $row->pharm_id; ?>'><i class="mdi mdi-check-circle"></i></a>
                          <a href='admin_pages_view_single_pharmaceutical.php?pharm_id=<?php echo $row->pharm_id; ?>'><i class="mdi mdi-eye-check-outline"></i></a>
                        </td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
