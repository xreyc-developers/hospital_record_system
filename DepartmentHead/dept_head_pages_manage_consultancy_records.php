                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td><a class="badge badge-danger" href='dept_head_pages_manage_consultancy_records.php?del=<?php echo $row->id; ?>' onClick="return confirm('Remove  This Record?');"><i class="mdi mdi-delete"></i> Delete</a>
                          <a class="badge badge-success" href='dept_head_pages_view_consultation.php?id=<?php echo $row->id; ?>'><i class="mdi mdi-eye-check-outline"></i> View</a>
                        </td>
                      </tr>
                    </tbody>
                  <?php $cnt = $cnt + 1;
