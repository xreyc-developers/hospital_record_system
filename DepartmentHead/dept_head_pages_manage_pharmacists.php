                  ...
                  ?>
                    <tbody class="no-border-x">
                      <tr>
                        ...
                        <td><a href='admin_pages_manage_pharmacist.php?del=<?php echo $row->em_id; ?>' onClick="return confirm('Remove  This Record?');"><i class="mdi mdi-delete"></i></a>
                          <a href='admin_pages_manage_single_employee.php?em_id=<?php echo $row->em_id; ?>'><i class="mdi mdi-check-circle"></i></a>
